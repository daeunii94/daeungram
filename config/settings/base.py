...
)  # (daeungram/config/settings/base.py - 3 = daeungram/)
APPS_DIR = ROOT_DIR.path("daeungram")
...
THIRD_PARTY_APPS = [
    ...
    "rest_auth", # rest auth
    "rest_auth.registration", #enable registrationx
...
MIGRATION_MODULES = {"sites": "daeungram.contrib.sites.migrations"}
...
ADMINS = [("""daeunyang""", "ilu94@naver.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "daeungram.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "daeungram.users.adapters.SocialAccountAdapter"
